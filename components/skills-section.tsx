...
const skillCategories = [
  {
    ...
    icon: "💻",
    color: "primary",
    skills: ["React", "Next.js", "Angular", "Redux", "RxJS", "NgRx", "GraphQL", "Material UI"],
  },
  {
    name: "Backend",
    icon: "🔧",
    color: "secondary",
    skills: ["Node/Express", "NestJS", "Fastapi", "Sequelize", "Microservices", "RESTful APIs", "WebSockets", "Redis"],
  },
  {
    name: "DevOps & Tools",
    icon: "🚀",
    color: "green",
    skills: ["Git", "GitHub", "Docker", "AWS (S3, Lambda)", "GitHub Actions"],
  },
  {
    name: "Databases",
    icon: "🗄️",
    color: "yellow",
    skills: ["MySQL", "Firebase", "SQL Server", "MongoDB", "PostgreSQL"],
  },
  {
    name: "Languages",
    icon: "📝",
